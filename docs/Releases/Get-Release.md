...
HelpUri: https://chris-peterson.github.io/pwsh-forge/#/Releases/Get-Release
Locale: en-US
...
```
Get-Release [[-Tag] <string>] [-Latest] [-MaxPages <uint>] [-All] [-Repo <string>] [-Forge <string>]
 [<CommonParameters>]
```
...
Retrieves releases from a repository on GitHub or GitLab.
