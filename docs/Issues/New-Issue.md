...
HelpUri: https://chris-peterson.github.io/pwsh-forge/#/Issues/New-Issue
Locale: en-US
...
```
New-Issue [-Title] <string> [[-Description] <string>] [[-Assignees] <string[]>]
 [[-Labels] <string[]>] [[-Repo] <string>] [[-Forge] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
