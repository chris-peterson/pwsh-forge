...
.DESCRIPTION
    ...
    ForgeCli.psd1. Run by the release workflow before publishing, and locally
...
.EXAMPLE
    ./build/Update-ReleaseArtifacts.ps1 -Version v0.13.0
#>
[CmdletBinding(SupportsShouldProcess)]
[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingWriteHost', '',
    Justification = 'The closing summary is meant for the CI job log, not the pipeline.')]
param(
    # The release version, with or without a leading 'v' (e.g. v0.13.0 or 0.13.0).
    [Parameter(Mandatory)]
    [string]
    $Version,
    ...
    [string]
    $ManifestPath = (Join-Path $PSScriptRoot '../src/ForgeCli/ForgeCli.psd1'),
...
if ($NormalizedVersion -notmatch '^\d+\.\d+\.\d+$') {
    throw "Version '$Version' is not a three-part version (e.g. v0.13.0)."
}
